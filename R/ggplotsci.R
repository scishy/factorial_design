...
plot_the_response <- function(fit, # model fit from lm, lmer, nlme, glmmTMB
                              fit_emm,
                              fit_pairs,
                              wrap_col=NULL,
                              x_label = "none",
...
#### gg_response ####
gg_response <- function(fit, # model fit from lm, lmer, nlme, glmmTMB
                        fit_emm,
                        fit_pairs,
                        wrap_col = NULL,
                        x_label = "none",
  ...
  if(sum(p_show) > 0){ # show p-values
    ...
    y_position <- max_y + increment*p_pos
    gg <- gg + 
      stat_pvalue_manual(fit_pairs_dt[p_show],
                         label = "p",
                         y.position = y_position,
                         xmin = "x_min_col",
                         xmax = "x_max_col",
